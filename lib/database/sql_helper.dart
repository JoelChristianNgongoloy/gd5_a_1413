...
class SQLHelper {
  ...
  static Future<int> addEmployee(String name, String email, String hobi) async {
    final db = await SQLHelper.db();
    final data = {'name': name, 'email': email, 'hobi': hobi};
  ...
  static Future<int> editEmployee(int id, String name, String email, String hobi) async {
    final db = await SQLHelper.db();
    final data = {'name': name, 'email': email, 'hobi' : hobi};
